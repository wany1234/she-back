...
import com.she.rsa.workRiskEval.service.WorkRiskEval08Service;
 ...
 */
@RestController
@RequestMapping("api/rsa/workRiskEval08")
public class WorkRiskEval08Controller {
    ...
    @Autowired
    private WorkRiskEval08Service workRiskEval08Service;
     ...
     * @throws Exception
     */
    @GetMapping("/workRiskEval08List")
    public ResponseEntity<List<WorkRiskEval08>> getworkRiskEval08List(@RequestParam HashMap<String, Object> parameter, @ModelAttribute DefaultParam defaultParam) throws Exception {
        ...
        return ResponseEntity.ok().body(workRiskEval08Service.getworkRiskEval08List(plantCd, deptCd, evalTypeCd, processNm, unitWorkNm, startYear, endYear, defaultParam));
    }
