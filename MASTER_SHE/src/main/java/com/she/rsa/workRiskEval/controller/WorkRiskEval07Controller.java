...
import com.she.rsa.workRiskEval.service.WorkRiskEval07Service;
 ...
 */
@RestController
@RequestMapping("api/rsa/workRiskEval07")
public class WorkRiskEval07Controller {
    ...
    @Autowired
    private WorkRiskEval07Service workRiskEval07Service;

    /**
     * 작업위험성평가 사업장 중요위험등록부 조회
     * 
     * @return 작업위험성평가 사업장 중요위험등록부 목록
     * @throws Exception
     */
    @GetMapping("/workRiskEval07List")
    public ResponseEntity<List<WorkRiskEval07>> getworkRiskEval07List(@RequestParam HashMap<String, Object> parameter, @ModelAttribute DefaultParam defaultParam) throws Exception {
        ...
        return ResponseEntity.ok().body(workRiskEval07Service.getworkRiskEval07List(plantCd, deptCd, evalTypeCd, processNm, unitWorkNm, startYear, endYear, defaultParam));
    }
