...
public class SubconEvalItemController {
    @Autowired
    private RequestMapper requestMapper;

    @Autowired
    private SubconEvalItemService subconEvalItemService;
    ...
    public ResponseEntity<List<SubconEvalItem>> getSubconEvalItems(@RequestParam HashMap<String, Object> parameter, @ModelAttribute DefaultParam defaultParam)
            throws Exception {
        ...
        return ResponseEntity.ok()
                .body(subconEvalItemService.getSubconEvalItems(subconEvalClsCd, subconEvalItemNm, useYn, defaultParam));
    }
    ...
    public ResponseEntity<SubconEvalItem> getSubconEvalItem(
            @PathVariable(name = "safSubconEvalItemNo") int safSubconEvalItemNo, @ModelAttribute DefaultParam defaultParam) throws Exception {
        return ResponseEntity.ok().body(this.subconEvalItemService.getSubconEvalItem(safSubconEvalItemNo, defaultParam));
    }
