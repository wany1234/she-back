...
@Mapper
@Repository("com.she.vendor.baseInfo.mapper.SubconEvalItemMapper")
public interface SubconEvalItemMapper {
    /**
     * 협력업체평가항목 조회
     * 
     ...
     * @throws Exception
     */
    public List<SubconEvalItem> getSubconEvalItems(@Param("subconEvalClsCd") String subconEvalClsCd,
            @Param("subconEvalItemNm") String subconEvalItemNm, @Param("useYn") String useYn, @Param("defaultParam") DefaultParam defaultParam) throws Exception;
     ...
     * @throws Exception
     */
    public SubconEvalItem getSubconEvalItem(@Param("safSubconEvalItemNo") int safSubconEvalItemNo, @Param("defaultParam") DefaultParam defaultParam) throws Exception;
