...
import com.she.vendor.baseInfo.mapper.VendorSubconEvalItemMapper;
import com.she.vendor.model.SubconEvalItem;

@Service
public class VendorSubconEvalItemService {
    @Autowired
    private VendorSubconEvalItemMapper subconEvalItemMapper;
     ...
     * @throws Exception
     */
    public List<SubconEvalItem> getSubconEvalItems(String subconEvalPlantCd, String subconEvalClsCd,
            String subconEvalAttCd, String subconEvalItemNm, String useYn) throws Exception {
        return subconEvalItemMapper.getSubconEvalItems(subconEvalPlantCd, subconEvalClsCd, subconEvalAttCd,
                subconEvalItemNm, useYn);
    }
     ...
     * @throws Exception
     */
    public SubconEvalItem getSubconEvalItem(int safSubconEvalItemNo) throws Exception {
        return this.subconEvalItemMapper.getSubconEvalItem(safSubconEvalItemNo);
    }
