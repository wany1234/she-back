...
public class JcoUtil {
	 ...
	 * SAP 테이블 데이터 조회
	 * 
	 * @param functionName RFC함수명
	 * @param tableName    조회할테이블명
	 * @return
	 */
	public static List<Map<String, Object>> getSapTableData(String functionName, String tableName) throws Exception {
	 ...
	 * @param tableName    조회할테이블명
	 * @param params       입력파라미터
	 * @param isNeedTime   날짜에 시분초 추가 여부
	 * @return
	 */
	public static List<Map<String, Object>> getSapTableData(String functionName, String tableName,
			Map<String, Object> params, boolean isNeedTime) throws Exception {
	 ...
	 * @return
	 */
	public static Map<String, Object> setSapTableData(String functionName, Map<String, Object> params)
			throws Exception {
		Map<String, Object> resultMap = new HashMap<String, Object>();

		try {
			logger.info("#### setSapTableData start ####");
			SapDestinationMgr.start();
			...
			resultMap.put("RsltCd", emlist.getString("E_MSGTYP"));
			resultMap.put("RsltMsg", emlist.getString("E_MESSAGE"));

			logger.info("#### setSapTableData end ####");
	 ...
	 * @return
	 */
	public static List<Map<String, Object>> getSapFileData(String functionName, String tableName,
			Map<String, Object> params) throws Exception {
		List<Map<String, Object>> resultList = new ArrayList<Map<String, Object>>();
		...
		try {
			...
			JCoParameterList emlist = function.getExportParameterList();
			// String exPara1 = emlist.getString("E_MESSAGE");
			// logger.info("#### result: " + exPara1);
